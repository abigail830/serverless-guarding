...
class HandlerTest {
    ...
    fun getProjectWithS3_with_all_provided() {
        val input = mapOf("input" to "{\"s3Info\":{\"bucketName\":\"clone-prj-to-s3\",\"projectName\":\"parkinglot\",\"s3Folder\":\"parkinglot/1607226848644\"},\"repoUrl\":\"https://github.com/qicaisheng/parkinglot.git\",\"userName\":\"abigail830\",\"password\":\"pwd\",\"branch\":\"master\"}")
        val handler = Handler();
        ...
        assertEquals("clone-prj-to-s3", result.s3Info.bucketName)
    ...
    fun getProjectWithS3_with_partial_provided() {
        val input = mapOf("input" to "{\"s3Info\":{\"bucketName\":\"clone-prj-to-s3\"},\"repoUrl\":\"https://github.com/qicaisheng/parkinglot.git\",\"userName\":\"abigail830\",\"branch\":\"master\"}")
        val handler = Handler();
        val result = handler.getProjectWithS3(input)
